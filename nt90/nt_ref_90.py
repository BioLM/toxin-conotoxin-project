...
for batch, total, link in get_batch(url):
    ...
    with open('/home/chance/biolmtoxin/toxin-conotoxin-project/UniRef/UniRef_NotToxins/90level/ntref100-4to500#'+str(progress)+'.tsv', 'w') as f:
        ...
        with open('/home/chance/biolmtoxin/toxin-conotoxin-project/UniRef/UniRef_NotToxins/90level/ntref90-4to500.txt', 'w') as f2:
            print([f'{progress} / {total}',link],file=f2)
        with open('/home/chance/biolmtoxin/toxin-conotoxin-project/UniRef/UniRef_NotToxins/90level/ntref90-4to500links.txt', 'w') as f3:
            print('\n'+link,file=f3)